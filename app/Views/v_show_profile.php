        ...
        <div class="row">
            ...
            <div class="col-6">
                <div class="container my-5 p-5 rounded" style="background-color: white;">
                    <h4 style="text-align: center; font-weight: bold;">ข้อมูลส่วนตัว</h4>
                    <hr>
                    <table class="table">
                        <tr>
                            <td><h5>รหัสพนักงาน:</h3</td>
                            <td><h5><?php echo $arr_emp->emp_code; ?></h5></td>
                        </tr>
                        <tr>
                            <td><h5>ชื่อ-นามสกุล:</h5></td>
                            <td><h5><?php echo $arr_emp->emp_name; ?></h5></td>
                        </tr>
                        <tr>
                            <td><h5>อีเมล:</h5></td>
                            <td><h5><?php echo $arr_emp->emp_email; ?></h5></td>
                        </tr>
                    </table>   
                </div>    
            </div>
